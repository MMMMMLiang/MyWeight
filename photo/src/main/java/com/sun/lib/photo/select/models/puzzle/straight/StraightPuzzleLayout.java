package com.sun.lib.photo.select.models.puzzle.straight;
...
import com.sun.lib.photo.select.models.puzzle.Line;
...
import static com.sun.lib.photo.select.models.puzzle.straight.StraightUtils.createLine;
import static com.sun.lib.photo.select.models.puzzle.straight.StraightUtils.cutAreaCross;
import static com.sun.lib.photo.select.models.puzzle.straight.StraightUtils.cutAreaSpiral;
  ...
  private void updateLowerLine(final Line line) {
    for (int i = 0; i < lines.size(); i++) {
      ...
      if (l.direction() == Line.Direction.HORIZONTAL) {
        if (l.maxX() <= line.minX() || line.maxX() <= l.minX()) {
          continue;
        }
        ...
        if (l.maxY() <= line.minY() || line.maxY() <= l.minY()) {
          continue;
        }

...
import com.sun.lib.photo.select.ui.adapter.PuzzleSelectorAdapter;
import com.sun.lib.photo.select.ui.adapter.PuzzleSelectorPreviewAdapter;
...
public class PuzzleSelectorActivity extends AppCompatActivity implements View.OnClickListener, AlbumItemsAdapter.OnClickListener, PuzzleSelectorAdapter.OnClickListener, PuzzleSelectorPreviewAdapter.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (R.id.iv_back == id) {
            ...
            PuzzleActivity.startWithPhotos(this, selectedPhotos,
                    Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + getString(R.string.app_name),
                    "IMG", Code.REQUEST_PUZZLE, false, Setting.imageEngine);

package com.sun.lib.photo.watcher;
...
public class ImageWatcher extends FrameLayout implements GestureDetector.OnGestureListener, ViewPager.OnPageChangeListener  {
     ...
     * 显示中的图片最小缩小系数
     */
    protected final float MIN_SCALE = 0.5f;
    /**
     * 显示中的图片最大放大系数
     */
    protected final float MAX_SCALE = 3.6f;
    /**
     * 缩放灵敏度 越小越灵敏
     */
    protected float scaleSensitivity = 0.3f;
    /**
     * 边缘阻尼弹性 越小越难拉动
     */
    protected float edgeResilience = 0.16f;
     ...
     * 图片加载失败站位图
     */
    protected int mErrorImageRes = R.drawable.error_picture;
    /**
     * // 状态栏高度
     */
    ...
    /**
     * // 图片所在的ImageView控件集合，Int类型的Key对应position
     */
    ...
    /**
     * // dismiss detach parent 退出查看大图模式后，立即释放内存
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                 ...
                 * // 正在查看一张图片，不处于翻页中。
                 */
                if (mPagerPositionOffsetPixels == 0) {
        ...
        try {
            if (e2 != null) {
                ...
                if (Math.abs(moveY) > mTouchSlop * 3 && Math.abs(moveX) < mTouchSlop && mPagerPositionOffsetPixels == 0) {
                    ...
                    // 下拉返回不灵 mTouchMode SLIDE 变化为 EXIT
    ...
    private void handleScaleTouchResult() {
        ...
        if (iSource.getWidth() * vsCurrent.scaleX > mWidth) {
            ...
            // 缩放结果X轴比屏幕宽度长
            vsTemp.translationX(endTranslateX);
        }
    ...
    class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            if (loadView == null) {
                // 占位;errorView = getChildAt(2)
                loadView = new View(container.getContext());
            }

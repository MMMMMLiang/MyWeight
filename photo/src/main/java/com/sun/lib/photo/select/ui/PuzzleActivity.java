package com.sun.lib.photo.select.ui;
...
import com.sun.lib.photo.select.constant.Code;
import com.sun.lib.photo.select.constant.Key;
import com.sun.lib.photo.select.engine.ImageEngine;
import com.sun.lib.photo.select.models.album.entity.Photo;
import com.sun.lib.photo.select.models.puzzle.Area;
import com.sun.lib.photo.select.models.puzzle.DegreeSeekBar;
import com.sun.lib.photo.select.models.puzzle.PuzzleLayout;
import com.sun.lib.photo.select.models.puzzle.PuzzlePiece;
import com.sun.lib.photo.select.models.puzzle.PuzzleUtils;
import com.sun.lib.photo.select.models.puzzle.PuzzleView;
import com.sun.lib.photo.select.models.sticker.StickerModel;
import com.sun.lib.photo.select.setting.Setting;
import com.sun.lib.photo.select.ui.adapter.PuzzleAdapter;
import com.sun.lib.photo.select.ui.adapter.TextStickerAdapter;
import com.sun.lib.photo.select.utils.bitmap.SaveBitmapCallBack;
import com.sun.lib.photo.select.utils.media.DurationUtils;
import com.sun.lib.photo.select.utils.permission.PermissionUtil;
import com.sun.lib.photo.select.utils.settings.SettingsUtils;
...
public class PuzzleActivity extends AppCompatActivity implements View.OnClickListener, PuzzleAdapter.OnItemClickListener, TextStickerAdapter.OnItemClickListener {
    ...
    public static void startWithPhotos(android.app.Fragment fragment, ArrayList<Photo> photos, String puzzleSaveDirPath, String puzzleSaveNamePrefix, int requestCode, boolean replaceCustom, @NonNull ImageEngine imageEngine) {
        if (null != toClass) {
            toClass.clear();
            toClass = null;
        }
    ...
    public static void startWithPaths(android.app.Fragment fragment, ArrayList<String> paths, String puzzleSaveDirPath, String puzzleSaveNamePrefix, int requestCode, boolean replaceCustom, @NonNull ImageEngine imageEngine) {
        if (null != toClass) {
            toClass.clear();
            toClass = null;
        }
